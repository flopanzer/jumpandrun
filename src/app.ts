...
class App {
    ...
    private _createCanvas(): HTMLCanvasElement {
        ...
        // create canvas element and attach it to webpage
    ...
    private async _goToGame(){
        ...
        // remove start scene, switch to gamescene and change states
        this._scene.dispose();
        this._state = State.GAME;
        this._scene = scene;
        this._engine.hideLoadingUI();
        this._scene.attachControl(); // game is rdy, attach control
    }
